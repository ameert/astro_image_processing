...
for model in model_list:
    cmd = "select a.simcount, a.n_bulge, a.r_bulge, a.m_bulge, a.ba_bulge, a.r_disk, a.m_disk, a.ba_disk, a.BT, a.zeropoint, a.pa_bulge, a.pa_disk, a.z, If(b.petroR50_r*d.kpc_per_arcsec/a.kpc_per_arcsec<1.5, 1.5,b.petroR50_r*d.kpc_per_arcsec/a.kpc_per_arcsec) from  sim_input as a, CAST as b, DERT as d where  a.galcount = b.galcount and a.galcount = d.galcount and a.galcount between %d and %d and model = '%s' order by a.simcount;" %(start, stop, model)
    ...
    for g1, n1, re1, Ie1, eb1, rd1, Id1, ed1, BT1, zeropoint_sdss_r1,bpa1, dpa1, z1, petroR50_r1, half_rad1 in zip(galcount, n, re, Ie, eb, rd, Id, ed, BT, zeropoint_sdss_r,bpa, dpa, z, petroR50_r, half_rad):
        ...
        #try:
            ...
            gal = galaxy('/home/ameert/andre_bcg/sims/',name,Ie_count,Id_count, rd1, inc, dpa1, re1, eb1, bpa1, n1, bulge_mag = Ie1, disk_mag = Id1, zp = zeropoint_sdss_r1, half_light_arcsec = half_rad1)#, psf_name= psf_image )
            gal.make_profile()
