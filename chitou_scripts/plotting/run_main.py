...
python cmp_main.py -1 band -2 simard -m ser -b r -x mtot -y mtot -f -z ser --title "PyMorph vs S11, S11 sample" --conditions "  and sfit.galcount = a.galcount and sfit.Prob_Ps > 0.32 " --add_tables ", r_simard_fit as sfit " --yl "-0.2,0.2" --ytM 0.1 --ytm 0.025 
python cmp_main.py -1 band -2 simard -m ser -b r -x hrad -y hrad -f -z ser --title "PyMorph vs S11, S11 sample" --conditions "  and sfit.galcount = a.galcount and sfit.Prob_Ps > 0.32 " --add_tables ", r_simard_fit as sfit " --yl "-0.2,0.2" --ytM 0.1 --ytm 0.025 
python cmp_main.py -1 band -2 simard -m ser -b r -x mtot -y hrad -f -z ser --title "PyMorph vs S11, S11 sample" --conditions "  and sfit.galcount = a.galcount and sfit.Prob_Ps > 0.32 " --add_tables ", r_simard_fit as sfit " --yl "-0.2,0.2" --ytM 0.1 --ytm 0.025 
python cmp_main.py -1 band -2 simard -m ser -b r -x rbulge -y rbulge -f -z ser --title "PyMorph vs S11, S11 sample" --conditions "  and sfit.galcount = a.galcount and sfit.Prob_Ps > 0.32 " --add_tables ", r_simard_fit as sfit " --yl "-0.2,0.2" --ytM 0.1 --ytm 0.025 
python cmp_main.py -1 band -2 simard -m ser -b r -x mtot -y rbulge -f -z ser --title "PyMorph vs S11, S11 sample" --conditions "  and sfit.galcount = a.galcount and sfit.Prob_Ps > 0.32 " --add_tables ", r_simard_fit as sfit " --yl "-0.2,0.2" --ytM 0.1 --ytm 0.025 
python cmp_main.py -1 band -2 simard -m ser -b r -x nbulge -y nbulge -f -z ser --title "PyMorph vs S11, S11 sample" --conditions "  and sfit.galcount = a.galcount and sfit.Prob_Ps > 0.32 " --add_tables ", r_simard_fit as sfit " --yl "-1,1" --ytM 0.5 --ytm 0.25 
python cmp_main.py -1 band -2 simard -m ser -b r -x mtot -y nbulge -f -z ser --title "PyMorph vs S11, S11 sample" --conditions "  and sfit.galcount = a.galcount and sfit.Prob_Ps > 0.32 " --add_tables ", r_simard_fit as sfit " --yl "-1,1" --ytM 0.5 --ytm 0.25
python cmp_main.py -1 band -2 simard -m ser -b r -x hrad -y nbulge -f -z ser --title "PyMorph vs S11, S11 sample" --conditions "  and sfit.galcount = a.galcount and sfit.Prob_Ps > 0.32 " --add_tables ", r_simard_fit as sfit " --yl "-1,1" --ytM 0.5 --ytm 0.25
python cmp_main.py -1 band -2 simard -m ser -b r -x rbulge -y nbulge -f -z ser --title "PyMorph vs S11, S11 sample" --conditions "  and sfit.galcount = a.galcount and sfit.Prob_Ps > 0.32 " --add_tables ", r_simard_fit as sfit " --yl "-1,1" --ytM 0.5 --ytm 0.25
python cmp_main.py -1 band -2 simard -m ser -b r -x sky -y mtot -f -z ser --title "PyMorph vs S11, S11 sample" --conditions "  and sfit.galcount = a.galcount and sfit.Prob_Ps > 0.32 " --add_tables ", r_simard_fit as sfit " --yl "-0.2,0.2" --ytM 0.1 --ytm 0.025 --xl "-1.0,0.5" --xtM 0.5 --xtm 0.25 --xtl "%0.1f"
python cmp_main.py -1 band -2 simard -m ser -b r -x sky -y mtot_abs -f -z ser --title "PyMorph vs S11, S11 sample" --conditions "  and sfit.galcount = a.galcount and sfit.Prob_Ps > 0.32 " --add_tables ", r_simard_fit as sfit " --yl "-0.2,0.2" --ytM 0.1 --ytm 0.025 --xl "-1.0,0.5" --xtM 0.5 --xtm 0.25 --xtl "%0.1f"
python cmp_main.py -1 band -2 simard -m ser -b r -x sky -y hrad -f -z ser --title "PyMorph vs S11, S11 sample" --conditions "  and sfit.galcount = a.galcount and sfit.Prob_Ps > 0.32 " --add_tables ", r_simard_fit as sfit "
python cmp_main.py -1 band -2 simard -m ser -b r -x sky -y rbulge -f -z ser --title "PyMorph vs S11, S11 sample" --conditions "  and sfit.galcount = a.galcount and sfit.Prob_Ps > 0.32 " --add_tables ", r_simard_fit as sfit "
python cmp_main.py -1 band -2 simard -m ser -b r -y sky -x mtot -f -z ser --title "PyMorph vs S11, S11 sample" --conditions "  and sfit.galcount = a.galcount and sfit.Prob_Ps > 0.32 " --add_tables ", r_simard_fit as sfit "
python cmp_main.py -1 band -2 simard -m ser -b r -y sky -x mtot_abs -f -z ser --title "PyMorph vs S11, S11 sample" --conditions "  and sfit.galcount = a.galcount and sfit.Prob_Ps > 0.32 " --add_tables ", r_simard_fit as sfit " --xl "-23,-16" --xtM 1 --xtm 0.25 --yl "-0.75,0.5" --ytM 0.25 --ytm 0.05 --ytl "%0.2f"
python cmp_main.py -1 band -2 simard -m ser -b r -y sky -x hrad -f -z ser --title "PyMorph vs S11, S11 sample" --conditions "  and sfit.galcount = a.galcount and sfit.Prob_Ps > 0.32 " --add_tables ", r_simard_fit as sfit "
python cmp_main.py -1 band -2 simard -m ser -b r -y sky -x rbulge -f -z ser --title "PyMorph vs S11, S11 sample" --conditions "  and sfit.galcount = a.galcount and sfit.Prob_Ps > 0.32 " --add_tables ", r_simard_fit as sfit "
