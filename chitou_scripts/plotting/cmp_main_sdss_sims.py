...
data = get_data_sdss_sim(cursor, '%s_%s' %(options['table1'],options['model1']), 'sim_input', flags = options['use_flags'], flagmodel = options['flagmodel'], add_tables = options['add_tables'], conditions = options['conditions'])
