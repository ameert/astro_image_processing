...
python cmp_main.py -1 band -2 sdss -m dev -b r -x petromag -y hrad -f -z dev --title "PyMorph vs SDSS, ffracdev=1" --conditions " and c.fracdev_r =1 " --yl "-0.2,0.2" --ytM 0.1 --ytm 0.05 --ylab '1 - (r$_{\mathrm{SDSS}}$/r$_{\mathrm{pm}}$)$_{\mathrm{hl}}$'
...
python cmp_main.py -1 band -2 sdss -m dev -b r -x petromag_abs -y mtot -f -z dev --title "PyMorph vs SDSS (fracdev=1)" --conditions " and c.fracdev_r =1 " --yl "-0.15,0.1" --ytM 0.05 --ytm 0.025 --ytl "%0.2f" --xl "-23,-17" --bins "-23.0,-16.99,0.5"
python cmp_main.py -1 band -2 sdss -m dev -b r -x petromag_abs -y mtot -f -z dev --add_tables ", r_lackner_fit as lfit " --conditions " and lfit.galcount = a.galcount and lfit.model ='dvc' " -p "_lackner_only" -u 50 --title "PyMorph vs SDSS (LG12 sample)"  --yl "-0.15,0.1" --ytM 0.05 --ytm 0.025 --ytl "%0.2f" --xl "-23,-17" --bins "-23.0,-16.99,0.5"

python cmp_main.py -1 band -2 sdss -m dev -b r -x petromag_abs -y hrad -f -z dev --title "PyMorph vs SDSS, ffracdev=1" --conditions " and c.fracdev_r =1 " --yl "-0.2,0.2" --ytM 0.1 --ytm 0.05 --xl "-23,-17" --bins "-23.0,-16.99,0.5" --ylab '1 - (r$_{\mathrm{SDSS}}$/r$_{\mathrm{pm}}$)$_{\mathrm{hl}}$'
python cmp_main.py -1 band -2 sdss -m dev -b r -x petromag_abs -y hrad -f -z dev --add_tables ", r_lackner_fit as lfit " --conditions " and lfit.galcount = a.galcount and lfit.model = 'dvc' " -p "_lackner_only" -u 50 --title "PyMorph vs SDSS (LG12 sample)" --yl "-0.2,0.2" --ytM 0.1 --ytm 0.05 --xl "-23,-17" --bins "-23.0,-16.99,0.5" --ylab '1 - (r$_{\mathrm{SDSS}}$/r$_{\mathrm{pm}}$)$_{\mathrm{hl}}$'
...
python cmp_main.py -1 band -2 sdss -m dev -b r -x petromag_abs -y sky  -f -z dev --title "PyMorph vs SDSS (fracdev=1)" --conditions " and c.fracdev_r =1 " --xl "-24,-19" --bins "-24.0,-18.99,0.5"
...
python cmp_main.py -1 band -2 lackner -m dev -b r -x petromag_abs -y mtot -f -z dev --title "PyMorph vs LG12 (LG12 sample)" --conditions "  and lfit.galcount = a.galcount and lfit.model = 'dvc' " --add_tables ", r_lackner_fit as lfit " -u 50  --yl "-0.15,0.1" --ytM 0.05 --ytm 0.025 --ytl "%0.2f" --xl "-23,-17" --bins "-23.0,-16.99,0.5" 

python cmp_main.py -1 band -2 lackner -m dev -b r -x petromag_abs -y hrad -f -z dev --title "PyMorph vs LG12 (LG12 sample)" --conditions "  and lfit.galcount = a.galcount and lfit.model = 'dvc' " --add_tables ", r_lackner_fit as lfit " -u 50 --yl "-0.2,0.2" --ytM 0.1 --ytm 0.05  --xl "-23,-17" --bins "-23.0,-16.99,0.5"   --ylab '1 - (r$_{\mathrm{LG12}}$/r$_{\mathrm{pm}}$)$_{\mathrm{hl}}$'

python cmp_main.py -2 sdss -1 lackner -m dev -b r -x petromag_abs -y hrad --title "LG12 vs SDSS (LG12 sample)" --conditions "  and lfit.galcount = a.galcount and lfit.model = 'dvc' " --add_tables ", r_lackner_fit as lfit " -u 50 --yl "-0.2,0.2" --ytM 0.1 --ytm 0.05  --xl "-23,-17" --bins "-23.0,-16.99,0.5"   --ylab '1 - (r$_{\mathrm{SDSS}}$/r$_{\mathrm{LG12}}$)$_{\mathrm{hl}}$'

python cmp_main.py -2 sdss -1 lackner -m dev -b r -x petromag_abs -y mtot --title "LG12 vs SDSS (LG12 sample)" --conditions "  and lfit.galcount = a.galcount and lfit.model = 'dvc' " --add_tables ", r_lackner_fit as lfit " -u 50  --yl "-0.15,0.1" --ytM 0.05 --ytm 0.025 --ytl "%0.2f"  --xl "-23,-17" --bins "-23.0,-16.99,0.5"
...
python cmp_main.py -1 band -2 simard -m ser -b r -x petromag_abs -y mtot -f -z ser --title "PyMorph vs S11 (S11 sample)" --conditions "  and sfit.galcount = a.galcount and sfit.Prob_Ps > 0.32 " --add_tables ", r_simard_fit as sfit " --yl "-0.2,0.2" --ytM 0.1 --ytm 0.05 --xl "-23,-17" --bins "-23.0,-16.99,0.5"
python cmp_main.py -1 band -2 simard -m ser -b r -x petromag_abs -y rbulge -f -z ser --title "PyMorph vs S11 (S11 sample)" --conditions "  and sfit.galcount = a.galcount and sfit.Prob_Ps > 0.32 " --add_tables ", r_simard_fit as sfit " --yl "-0.2,0.2" --ytM 0.1 --ytm 0.05 --xl "-23,-17" --bins "-23.0,-16.99,0.5"   --ylab '1 - (r$_{\mathrm{S11}}$/r$_{\mathrm{pm}}$)$_{\mathrm{bulge}}$'
python cmp_main.py -1 band -2 simard -m ser -b r -x petromag_abs -y nbulge -f -z ser --title "PyMorph vs S11 (S11 sample)" --conditions "  and sfit.galcount = a.galcount and sfit.Prob_Ps > 0.32 " --add_tables ", r_simard_fit as sfit " --yl "-0.2,0.2" --ytM 0.1 --ytm 0.05 --xl "-23,-17" --bins "-23.0,-16.99,0.5"
...
python cmp_main.py -1 band -2 simard -m ser -b r -x petromag -y rbulge -f -z ser --add_tables ", r_lackner_fit as lfit " --conditions " and lfit.galcount = a.galcount and lfit.model = 'ser'  " -p "_lackner_only" -u 100 --title "PyMorph vs S11 (LG12 sample)" --yl "-0.2,0.2" --ytM 0.1 --ytm 0.025   --ylab '1 - (r$_{\mathrm{S11}}$/r$_{\mathrm{pm}}$)$_{\mathrm{bulge}}$'
...
python cmp_main.py -1 band -2 simard -m ser -b r -x petromag_abs -y mtot -f -z ser --add_tables ", r_lackner_fit as lfit " --conditions " and lfit.galcount = a.galcount and lfit.model = 'ser'  " -p "_lackner_only" --title "PyMorph vs S11 (LG12 sample)" -u 100 --yl "-0.2,0.2" --ytM 0.1 --ytm 0.05 --xl "-23,-17" --bins "-23.0,-16.99,0.5"
python cmp_main.py -1 band -2 simard -m ser -b r -x petromag_abs -y rbulge -f -z ser --add_tables ", r_lackner_fit as lfit " --conditions " and lfit.galcount = a.galcount and lfit.model = 'ser'  " -p "_lackner_only" --title "PyMorph vs S11 (LG12 sample)"  -u 100 --yl "-0.2,0.2" --ytM 0.1 --ytm 0.05 --xl "-23,-17" --bins "-23.0,-16.99,0.5"   --ylab '1 - (r$_{\mathrm{S11}}$/r$_{\mathrm{pm}}$)$_{\mathrm{bulge}}$'
python cmp_main.py -1 band -2 simard -m ser -b r -x petromag_abs -y nbulge -f -z ser --add_tables ", r_lackner_fit as lfit " --conditions " and lfit.galcount = a.galcount and lfit.model = 'ser'  " -p "_lackner_only" --title "PyMorph vs S11 (LG12 sample)" -u 100 --yl "-0.2,0.2" --ytM 0.1 --ytm 0.05 --xl "-23,-17" --bins "-23.0,-16.99,0.5"
python cmp_main.py -1 band -2 simard -m ser -b r -x petrorad -y nbulge -f -z ser --add_tables ", r_lackner_fit as lfit " --conditions " and lfit.galcount = a.galcount and lfit.model = 'ser'  " -p "_lackner_only" --title "PyMorph vs S11 (LG12 sample)" -u 100 --yl "-0.2,0.2" --ytM 0.1 --ytm 0.05 --xl "-23,-17" --bins "-23.0,-16.99,0.5"

#mv r_band_simard_*.eps r_band_simard_*.tbl /home/ameert/git_projects/catalog2013/figures/cmp_plots/simard/


python cmp_main.py -1 band -2 lackner -m ser -b r -x petromag -y mtot -f -z ser  --title "PyMorph vs LG12 (LG12 sample)" --conditions "  and lfit.galcount = a.galcount and lfit.model = 'ser' " --add_tables ", r_lackner_fit as lfit " -u 100 --yl "-0.2,0.2" --ytM 0.1 --ytm 0.025 
python cmp_main.py -1 band -2 lackner -m ser -b r -x petromag -y rbulge -f -z ser  --title "PyMorph vs LG12 (LG12 sample)" --conditions "  and lfit.galcount = a.galcount and lfit.model = 'ser' " --add_tables ", r_lackner_fit as lfit " -u 100 --yl "-0.2,0.2" --ytM 0.1 --ytm 0.025  --ylab '1 - (r$_{\mathrm{LG12}}$/r$_{\mathrm{pm}}$)$_{\mathrm{bulge}}$'
python cmp_main.py -1 band -2 lackner -m ser -b r -x petromag -y nbulge -f -z ser  --title "PyMorph vs LG12 (LG12 sample)" --conditions "  and lfit.galcount = a.galcount and lfit.model = 'ser' " --add_tables ", r_lackner_fit as lfit " -u 100 --yl "-1,1" --ytM 0.5 --ytm 0.25
python cmp_main.py -1 band -2 lackner -m ser -b r -x petrorad -y nbulge -f -z ser  --title "PyMorph vs LG12 (LG12 sample)" --conditions "  and lfit.galcount = a.galcount and lfit.model = 'ser' " --add_tables ", r_lackner_fit as lfit " -u 100 --yl "-1,1" --ytM 0.5 --ytm 0.25

python cmp_main.py -1 band -2 lackner -m ser -b r -x petromag_abs -y mtot -f -z ser  --title "PyMorph vs LG12 (LG12 sample)" --conditions "  and lfit.galcount = a.galcount and lfit.model = 'ser' " --add_tables ", r_lackner_fit as lfit " -u 100 --yl "-0.2,0.2" --ytM 0.1 --ytm 0.05 --xl "-23,-17" --bins "-23.0,-16.99,0.5"
python cmp_main.py -1 band -2 lackner -m ser -b r -x petromag_abs -y rbulge -f -z ser  --title "PyMorph vs LG12 (LG12 sample)" --conditions "  and lfit.galcount = a.galcount and lfit.model = 'ser' " --add_tables ", r_lackner_fit as lfit " -u 100 --yl "-0.2,0.2" --ytM 0.1 --ytm 0.05 --xl "-23,-17" --bins "-23.0,-16.99,0.5"  --ylab '1 - (r$_{\mathrm{LG12}}$/r$_{\mathrm{pm}}$)$_{\mathrm{bulge}}$'
python cmp_main.py -1 band -2 lackner -m ser -b r -x petromag_abs -y nbulge -f -z ser  --title "PyMorph vs LG12 (LG12 sample)" --conditions "  and lfit.galcount = a.galcount and lfit.model = 'ser' " --add_tables ", r_lackner_fit as lfit " -u 100 --yl "-0.2,0.2" --ytM 0.1 --ytm 0.05 --xl "-23,-17" --bins "-23.0,-16.99,0.5"
python cmp_main.py -1 band -2 lackner -m ser -b r -x petrorad -y nbulge -f -z ser  --title "PyMorph vs LG12 (LG12 sample)" --conditions "  and lfit.galcount = a.galcount and lfit.model = 'ser' " --add_tables ", r_lackner_fit as lfit " -u 100 --yl "-1,1" --ytM 0.5 --ytm 0.25

python cmp_main.py -1 simard -2 lackner -m ser -b r -x petromag -y mtot -f -z ser  --title "Simard vs LG12 (LG12 sample)" --conditions "  and lfit.galcount = a.galcount and lfit.model = 'ser' " --add_tables ", r_lackner_fit as lfit " -u 100 --yl "-0.2,0.2" --ytM 0.1 --ytm 0.025 
python cmp_main.py -1 simard -2 lackner -m ser -b r -x petromag -y rbulge -f -z ser  --title "Simard vs LG12 (LG12 sample)" --conditions "  and lfit.galcount = a.galcount and lfit.model = 'ser' " --add_tables ", r_lackner_fit as lfit " -u 100 --yl "-0.2,0.2" --ytM 0.1 --ytm 0.025 --ylab '1 - (r$_{\mathrm{LG12}}$/r$_{\mathrm{S11}}$)$_{\mathrm{bulge}}$'
python cmp_main.py -1 simard -2 lackner -m ser -b r -x petromag -y nbulge -f -z ser  --title "Simard vs LG12 (LG12 sample)" --conditions "  and lfit.galcount = a.galcount and lfit.model = 'ser' " --add_tables ", r_lackner_fit as lfit " -u 100 --yl "-1,1" --ytM 0.5 --ytm 0.25
python cmp_main.py -1 simard -2 lackner -m ser -b r -x petrorad -y nbulge -f -z ser  --title "Simard vs LG12 (LG12 sample)" --conditions "  and lfit.galcount = a.galcount and lfit.model = 'ser' " --add_tables ", r_lackner_fit as lfit " -u 100 --yl "-1,1" --ytM 0.5 --ytm 0.25

python cmp_main.py -1 simard -2 lackner -m ser -b r -x petromag_abs -y mtot -f -z ser  --title "Simard vs LG12 (LG12 sample)" --conditions "  and lfit.galcount = a.galcount and lfit.model = 'ser' " --add_tables ", r_lackner_fit as lfit " -u 100 --yl "-0.2,0.2" --ytM 0.1 --ytm 0.05 --xl "-23,-17" --bins "-23.0,-16.99,0.5"
python cmp_main.py -1 simard -2 lackner -m ser -b r -x petromag_abs -y rbulge -f -z ser  --title "Simard vs LG12 (LG12 sample)" --conditions "  and lfit.galcount = a.galcount and lfit.model = 'ser' " --add_tables ", r_lackner_fit as lfit " -u 100 --yl "-0.2,0.2" --ytM 0.1 --ytm 0.05 --xl "-23,-17" --bins "-23.0,-16.99,0.5" --ylab '1 - (r$_{\mathrm{LG12}}$/r$_{\mathrm{S11}}$)$_{\mathrm{bulge}}$'
python cmp_main.py -1 simard -2 lackner -m ser -b r -x petromag_abs -y nbulge -f -z ser  --title "Simard vs LG12 (LG12 sample)" --conditions "  and lfit.galcount = a.galcount and lfit.model = 'ser' " --add_tables ", r_lackner_fit as lfit " -u 100 --yl "-0.2,0.2" --ytM 0.1 --ytm 0.05 --xl "-23,-17" --bins "-23.0,-16.99,0.5"
python cmp_main.py -1 simard -2 lackner -m ser -b r -x petrorad -y nbulge -f -z ser  --title "Simard vs LG12 (LG12 sample)" --conditions "  and lfit.galcount = a.galcount and lfit.model = 'ser' " --add_tables ", r_lackner_fit as lfit " -u 100 --yl "-1,1" --ytM 0.5 --ytm 0.25
...
python cmp_main.py -1 band -2 simard -m devexp -b r -x petromag_abs -y mtot -f -z devexp  --title "PyMorph vs S11 (S11 sample)" --conditions "  and sfit.galcount = a.galcount and sfit.Prob_n4 > 0.32 and sfit.Prob_pS <= 0.32 " --add_tables ", r_simard_fit as sfit " -u 100 --yl "-0.2,0.2" --ytM 0.1 --ytm 0.01 --xl "-23,-17" --bins "-23.0,-16.99,0.5"
python cmp_main.py -1 band -2 simard -m devexp -b r -x petrorad -y hrad -f -z devexp  --title "PyMorph vs S11 (S11 sample)" --conditions "  and sfit.galcount = a.galcount and sfit.Prob_n4 > 0.32 and sfit.Prob_pS <= 0.32 " --add_tables ", r_simard_fit as sfit " -u 100 --yl "-0.3,0.3" --ytM 0.1 --ytm 0.025 --xl "-23,-17" --bins "-23.0,-16.99,0.5"  --ylab '1 - (r$_{\mathrm{S11}}$/r$_{\mathrm{pm}}$)$_{\mathrm{hl}}$'
python cmp_main.py -1 band -2 simard -m devexp -b r -x petromag_abs -y hrad -f -z devexp  --title "PyMorph vs S11 (S11 sample)" --conditions "  and sfit.galcount = a.galcount and sfit.Prob_n4 > 0.32 and sfit.Prob_pS <= 0.32 " --add_tables ", r_simard_fit as sfit " -u 100 --yl "-0.3,0.3" --ytM 0.1 --ytm 0.025 --xl "-23,-17" --bins "-23.0,-16.99,0.5"  --ylab '1 - (r$_{\mathrm{S11}}$/r$_{\mathrm{pm}}$)$_{\mathrm{hl}}$'
python cmp_main.py -1 band -2 simard -m devexp -b r -x petromag_abs -y BT -f -z devexp --title "PyMorph vs S11 (S11 sample)" --conditions "  and sfit.galcount = a.galcount and sfit.Prob_n4 > 0.32 and sfit.Prob_pS <= 0.32 " --add_tables ", r_simard_fit as sfit "  -u 100 --xl "-23,-17" --bins "-23.0,-16.99,0.5"
python cmp_main.py -1 band -2 simard -m devexp -b r -x BT -y BT -f -z devexp  --title "PyMorph vs S11 (S11 sample)" --conditions "  and sfit.galcount = a.galcount and sfit.Prob_n4 > 0.32 and sfit.Prob_pS <= 0.32 " --add_tables ", r_simard_fit as sfit " -u 100 
python cmp_main.py -1 band -2 simard -m devexp -b r -x petromag_abs -y mbulge -f -z devexp  --title "PyMorph vs S11 (S11 sample)" --conditions "  and sfit.galcount = a.galcount and sfit.Prob_n4 > 0.32 and sfit.Prob_pS <= 0.32 " --add_tables ", r_simard_fit as sfit " -u 100 --xl "-23,-17" --bins "-23.0,-16.99,0.5"
python cmp_main.py -1 band -2 simard -m devexp -b r -x petromag_abs -y rbulge -f -z devexp  --title "PyMorph vs S11 (S11 sample)" --conditions "  and sfit.galcount = a.galcount and sfit.Prob_n4 > 0.32 and sfit.Prob_pS <= 0.32 " --add_tables ", r_simard_fit as sfit " -u 100 --xl "-23,-17" --bins "-23.0,-16.99,0.5" --ylab '1 - (r$_{\mathrm{S11}}$/r$_{\mathrm{pm}}$)$_{\mathrm{bulge}}$'
python cmp_main.py -1 band -2 simard -m devexp -b r -x petromag_abs -y mdisk -f -z devexp --title "PyMorph vs S11 (S11 sample)" --conditions "  and sfit.galcount = a.galcount and sfit.Prob_n4 > 0.32 and sfit.Prob_pS <= 0.32 " --add_tables ", r_simard_fit as sfit " -u 100 --yl "-0.2,0.2" --ytM 0.1 --ytm 0.01 --xl "-23,-17" --bins "-23.0,-16.99,0.5"
python cmp_main.py -1 band -2 simard -m devexp -b r -x petromag_abs -y rdisk -f -z devexp --title "PyMorph vs S11 (S11 sample)" --conditions "  and sfit.galcount = a.galcount and sfit.Prob_n4 > 0.32 and sfit.Prob_pS <= 0.32 " --add_tables ", r_simard_fit as sfit " -u 100 --yl "-0.2,0.2" --ytM 0.1 --ytm 0.01 --xl "-23,-17" --bins "-23.0,-16.99,0.5" --ylab '1 - (r$_{\mathrm{S11}}$/r$_{\mathrm{pm}}$)$_{\mathrm{disk}}$'
...
python cmp_main.py -1 band -2 simard -m devexp -b r -x petromag_abs -y mtot -f -z devexp --add_tables ", r_lackner_fit as lfit " --conditions " and lfit.galcount = a.galcount and lfit.model = 'nb4' " -p "_lackner_only" -u 100 --title "PyMorph vs S11 (LG12 sample)"  --yl "-0.2,0.2" --ytM 0.1 --ytm 0.01  --xl "-23,-17" --bins "-23.0,-16.99,0.5"
python cmp_main.py -1 band -2 simard -m devexp -b r -x petromag_abs -y hrad -f -z devexp --add_tables ", r_lackner_fit as lfit " --conditions " and lfit.galcount = a.galcount and lfit.model = 'nb4'  " -p "_lackner_only" -u 100 --title "PyMorph vs S11 (LG12 sample)" --yl "-0.3,0.3" --ytM 0.1 --ytm 0.025  --xl "-23,-17" --bins "-23.0,-16.99,0.5"   --ylab '1 - (r$_{\mathrm{S11}}$/r$_{\mathrm{pm}}$)$_{\mathrm{hl}}$'
python cmp_main.py -1 band -2 simard -m devexp -b r -x BT -y BT -f -z devexp --add_tables ", r_lackner_fit as lfit " --conditions " and lfit.galcount = a.galcount and lfit.model = 'nb4'  " -p "_lackner_only" -u 100 --title "PyMorph vs S11 (LG12 sample)"
python cmp_main.py -1 band -2 simard -m devexp -b r -x petromag_abs -y BT -f -z devexp --add_tables ", r_lackner_fit as lfit " --conditions " and lfit.galcount = a.galcount and lfit.model = 'nb4'  " -p "_lackner_only" -u 100 --title "PyMorph vs S11 (LG12 sample)" --xl "-23,-17" --bins "-23.0,-16.99,0.5"
python cmp_main.py -1 band -2 simard -m devexp -b r -x petromag_abs -y mbulge -f -z devexp --add_tables ", r_lackner_fit as lfit " --conditions " and lfit.galcount = a.galcount and lfit.model = 'nb4'  " -p "_lackner_only" -u 100 --title "PyMorph vs S11 (LG12 sample)" --xl "-23,-17" --bins "-23.0,-16.99,0.5"
python cmp_main.py -1 band -2 simard -m devexp -b r -x petromag_abs -y rbulge -f -z devexp --add_tables ", r_lackner_fit as lfit " --conditions " and lfit.galcount = a.galcount and lfit.model = 'nb4'  " -p "_lackner_only" -u 100 --title "PyMorph vs S11 (LG12 sample)" --xl "-23,-17" --bins "-23.0,-16.99,0.5"   --ylab '1 - (r$_{\mathrm{S11}}$/r$_{\mathrm{pm}}$)$_{\mathrm{bulge}}$'
python cmp_main.py -1 band -2 simard -m devexp -b r -x petromag_abs -y mdisk -f -z devexp --add_tables ", r_lackner_fit as lfit " --conditions " and lfit.galcount = a.galcount and lfit.model = 'nb4'  " -p "_lackner_only" -u 100 --title "PyMorph vs S11 (LG12 sample)" --yl "-0.2,0.2" --ytM 0.1 --ytm 0.01 --xl "-23,-17" --bins "-23.0,-16.99,0.5"
python cmp_main.py -1 band -2 simard -m devexp -b r -x petromag_abs -y rdisk -f -z devexp --add_tables ", r_lackner_fit as lfit " --conditions " and lfit.galcount = a.galcount and lfit.model = 'nb4'  " -p "_lackner_only" -u 100 --title "PyMorph vs S11 (LG12 sample)" --yl "-0.2,0.2" --ytM 0.1 --ytm 0.01 --xl "-23,-17" --bins "-23.0,-16.99,0.5"  --ylab '1 - (r$_{\mathrm{S11}}$/r$_{\mathrm{pm}}$)$_{\mathrm{disk}}$'
...
python cmp_main.py -1 band -2 lackner -m devexp -b r -x petromag_abs -y mtot -f -z devexp --title "PyMorph vs LG12 (LG12 sample)"  --conditions "  and lfit.galcount = a.galcount and lfit.model = 'nb4' " --add_tables ", r_lackner_fit as lfit " -u 100  --yl "-0.2,0.2" --ytM 0.1 --ytm 0.01 --xl "-23,-17" --bins "-23.0,-16.99,0.5"
python cmp_main.py -1 band -2 lackner -m devexp -b r -x petrorad -y hrad -f -z devexp  --title "PyMorph vs LG12 (LG12 sample)"  --conditions "  and lfit.galcount = a.galcount and lfit.model = 'nb4' " --add_tables ", r_lackner_fit as lfit " -u 100 --yl "-0.3,0.3" --ytM 0.1 --ytm 0.025  --xl "-23,-17" --bins "-23.0,-16.99,0.5"   --ylab '1 - (r$_{\mathrm{LG12}}$/r$_{\mathrm{pm}}$)$_{\mathrm{hl}}$'
python cmp_main.py -1 band -2 lackner -m devexp -b r -x petromag_abs -y hrad -f -z devexp  --title "PyMorph vs LG12 (LG12 sample)"  --conditions "  and lfit.galcount = a.galcount and lfit.model = 'nb4' " --add_tables ", r_lackner_fit as lfit " -u 100 --yl "-0.3,0.3" --ytM 0.1 --ytm 0.025  --xl "-23,-17" --bins "-23.0,-16.99,0.5"    --ylab '1 - (r$_{\mathrm{LG12}}$/r$_{\mathrm{pm}}$)$_{\mathrm{hl}}$'
python cmp_main.py -1 band -2 lackner -m devexp -b r -x BT -y BT -f -z devexp  --title "PyMorph vs LG12 (LG12 sample)"  --conditions "  and lfit.galcount = a.galcount and lfit.model = 'nb4' " --add_tables ", r_lackner_fit as lfit " -u 100 
python cmp_main.py -1 band -2 lackner -m devexp -b r -x petromag_abs -y BT -f -z devexp  --title "PyMorph vs LG12 (LG12 sample)"  --conditions "  and lfit.galcount = a.galcount and lfit.model = 'nb4' " --add_tables ", r_lackner_fit as lfit " -u 100 --xl "-23,-17" --bins "-23.0,-16.99,0.5"
python cmp_main.py -1 band -2 lackner -m devexp -b r -x petromag_abs -y mbulge -f -z devexp  --title "PyMorph vs LG12 (LG12 sample)"  --conditions "  and lfit.galcount = a.galcount and lfit.model = 'nb4' " --add_tables ", r_lackner_fit as lfit " -u 100 --xl "-23,-17" --bins "-23.0,-16.99,0.5"
python cmp_main.py -1 band -2 lackner -m devexp -b r -x petromag_abs -y rbulge -f -z devexp  --title "PyMorph vs LG12 (LG12 sample)"  --conditions "  and lfit.galcount = a.galcount and lfit.model = 'nb4' " --add_tables ", r_lackner_fit as lfit " -u 100 --xl "-23,-17" --bins "-23.0,-16.99,0.5"    --ylab '1 - (r$_{\mathrm{LG12}}$/r$_{\mathrm{pm}}$)$_{\mathrm{bulge}}$'
python cmp_main.py -1 band -2 lackner -m devexp -b r -x petromag_abs -y mdisk -f -z devexp  --title "PyMorph vs LG12 (LG12 sample)"  --conditions "  and lfit.galcount = a.galcount and lfit.model = 'nb4' " --add_tables ", r_lackner_fit as lfit " -u 100 --yl "-0.2,0.2" --ytM 0.1 --ytm 0.01 --xl "-23,-17" --bins "-23.0,-16.99,0.5"
python cmp_main.py -1 band -2 lackner -m devexp -b r -x petromag_abs -y rdisk -f -z devexp  --title "PyMorph vs LG12 (LG12 sample)"  --conditions "  and lfit.galcount = a.galcount and lfit.model = 'nb4' " --add_tables ", r_lackner_fit as lfit " -u 100 --yl "-0.2,0.2" --ytM 0.1 --ytm 0.01 --xl "-23,-17" --bins "-23.0,-16.99,0.5"    --ylab '1 - (r$_{\mathrm{LG12}}$/r$_{\mathrm{pm}}$)$_{\mathrm{disk}}$'
...
python cmp_main.py -1 simard -2 lackner -m devexp -b r -x petromag_abs -y mtot -f -z devexp --title "Simard vs LG12 (LG12 sample)"  --conditions "  and lfit.galcount = a.galcount and lfit.model = 'nb4' " --add_tables ", r_lackner_fit as lfit " -u 100  --yl "-0.2,0.2" --ytM 0.1 --ytm 0.01  --xl "-23,-17" --bins "-23.0,-16.99,0.5"
python cmp_main.py -1 simard -2 lackner -m devexp -b r -x petrorad -y hrad -f -z devexp  --title "Simard vs LG12 (LG12 sample)"  --conditions "  and lfit.galcount = a.galcount and lfit.model = 'nb4' " --add_tables ", r_lackner_fit as lfit " -u 100 --yl "-0.3,0.3" --ytM 0.1 --ytm 0.025  --xl "-23,-17" --bins "-23.0,-16.99,0.5"   --ylab '1 - (r$_{\mathrm{LG12}}$/r$_{\mathrm{S11}}$)$_{\mathrm{hl}}$'
python cmp_main.py -1 simard -2 lackner -m devexp -b r -x petromag_abs -y hrad -f -z devexp  --title "Simard vs LG12 (LG12 sample)"  --conditions "  and lfit.galcount = a.galcount and lfit.model = 'nb4' " --add_tables ", r_lackner_fit as lfit " -u 100 --yl "-0.3,0.3" --ytM 0.1 --ytm 0.025  --xl "-23,-17" --bins "-23.0,-16.99,0.5"  --ylab '1 - (r$_{\mathrm{LG12}}$/r$_{\mathrm{S11}}$)$_{\mathrm{hl}}$'
python cmp_main.py -1 simard -2 lackner -m devexp -b r -x BT -y BT -f -z devexp  --title "Simard vs LG12 (LG12 sample)"  --conditions "  and lfit.galcount = a.galcount and lfit.model = 'nb4' " --add_tables ", r_lackner_fit as lfit " -u 100 
python cmp_main.py -1 simard -2 lackner -m devexp -b r -x petromag_abs -y BT -f -z devexp  --title "Simard vs LG12 (LG12 sample)"  --conditions "  and lfit.galcount = a.galcount and lfit.model = 'nb4' " --add_tables ", r_lackner_fit as lfit " -u 100 --xl "-23,-17" --bins "-23.0,-16.99,0.5"
python cmp_main.py -1 simard -2 lackner -m devexp -b r -x petromag_abs -y mbulge -f -z devexp  --title "Simard vs LG12 (LG12 sample)"  --conditions "  and lfit.galcount = a.galcount and lfit.model = 'nb4' " --add_tables ", r_lackner_fit as lfit " -u 100 --xl "-23,-17" --bins "-23.0,-16.99,0.5"
python cmp_main.py -1 simard -2 lackner -m devexp -b r -x petromag_abs -y rbulge -f -z devexp  --title "Simard vs LG12 (LG12 sample)"  --conditions "  and lfit.galcount = a.galcount and lfit.model = 'nb4' " --add_tables ", r_lackner_fit as lfit " -u 100 --xl "-23,-17" --bins "-23.0,-16.99,0.5"   --ylab '1 - (r$_{\mathrm{LG12}}$/r$_{\mathrm{S11}}$)$_{\mathrm{bulge}}$'
python cmp_main.py -1 simard -2 lackner -m devexp -b r -x petromag_abs -y mdisk -f -z devexp  --title "Simard vs LG12 (LG12 sample)"  --conditions "  and lfit.galcount = a.galcount and lfit.model = 'nb4' " --add_tables ", r_lackner_fit as lfit " -u 100 --yl "-0.2,0.2" --ytM 0.1 --ytm 0.01 --xl "-23,-17" --bins "-23.0,-16.99,0.5"
python cmp_main.py -1 simard -2 lackner -m devexp -b r -x petromag_abs -y rdisk -f -z devexp  --title "Simard vs LG12 (LG12 sample)"  --conditions "  and lfit.galcount = a.galcount and lfit.model = 'nb4' " --add_tables ", r_lackner_fit as lfit " -u 100 --yl "-0.2,0.2" --ytM 0.1 --ytm 0.01 --xl "-23,-17" --bins "-23.0,-16.99,0.5"   --ylab '1 - (r$_{\mathrm{LG12}}$/r$_{\mathrm{S11}}$)$_{\mathrm{disk}}$'
...
python cmp_main.py -1 band -2 simard -m serexp -b r -x petromag_abs -y mtot -f -z serexp   --title "PyMorph vs S11 (S11 sample)"  --conditions "  and sfit.galcount = a.galcount and sfit.Prob_n4 <= 0.32 and sfit.Prob_pS <= 0.32 " --add_tables ", r_simard_fit as sfit " -u 100 --xl "-23,-17" --bins "-23.0,-16.99,0.5"  --yl "-0.2,0.2" --ytM 0.1 --ytm 0.025
python cmp_main.py -1 band -2 simard -m serexp -b r -x petrorad -y hrad -f -z serexp  --title "PyMorph vs S11 (S11 sample)"  --conditions "  and sfit.galcount = a.galcount and sfit.Prob_n4 <= 0.32 and sfit.Prob_pS <= 0.32 " --add_tables ", r_simard_fit as sfit " -u 100 --xl "-23,-17" --bins "-23.0,-16.99,0.5"  --yl "-0.2,0.2" --ytM 0.1 --ytm 0.025   --ylab '1 - (r$_{\mathrm{S11}}$/r$_{\mathrm{pm}}$)$_{\mathrm{hl}}$'
python cmp_main.py -1 band -2 simard -m serexp -b r -x petromag_abs -y hrad -f -z serexp   --title "PyMorph vs S11 (S11 sample)"  --conditions "  and sfit.galcount = a.galcount and sfit.Prob_n4 <= 0.32 and sfit.Prob_pS <= 0.32 " --add_tables ", r_simard_fit as sfit " -u 100 --xl "-23,-17" --bins "-23.0,-16.99,0.5"  --yl "-0.2,0.2" --ytM 0.1 --ytm 0.025   --ylab '1 - (r$_{\mathrm{S11}}$/r$_{\mathrm{pm}}$)$_{\mathrm{hl}}$'
python cmp_main.py -1 band -2 simard -m serexp -b r -x petromag_abs -y nbulge -f -z serexp  --title "PyMorph vs S11 (S11 sample)"  --conditions "  and sfit.galcount = a.galcount and sfit.Prob_n4 <= 0.32 and sfit.Prob_pS <= 0.32 " --add_tables ", r_simard_fit as sfit " -u 100 --xl "-23,-17" --bins "-23.0,-16.99,0.5"    --yl "-2,2" --ytM 1 --ytm 0.25
python cmp_main.py -1 band -2 simard -m serexp -b r -x petromag_abs -y BT -f -z serexp   --title "PyMorph vs S11 (S11 sample)"  --conditions "  and sfit.galcount = a.galcount and sfit.Prob_n4 <= 0.32 and sfit.Prob_pS <= 0.32 " --add_tables ", r_simard_fit as sfit " -u 100 --xl "-23,-17" --bins "-23.0,-16.99,0.5" 
python cmp_main.py -1 band -2 simard -m serexp -b r -x petromag_abs -y mbulge -f -z serexp  --title "PyMorph vs S11 (S11 sample)"  --conditions "  and sfit.galcount = a.galcount and sfit.Prob_n4 <= 0.32 and sfit.Prob_pS <= 0.32 " --add_tables ", r_simard_fit as sfit " -u 100 --xl "-23,-17" --bins "-23.0,-16.99,0.5" 
...
python cmp_main.py -1 band -2 simard -m serexp -b r -x petromag_abs -y mdisk -f -z serexp  --title "PyMorph vs S11 (S11 sample)"  --conditions "  and sfit.galcount = a.galcount and sfit.Prob_n4 <= 0.32 and sfit.Prob_pS <= 0.32 " --add_tables ", r_simard_fit as sfit " -u 100 --xl "-23,-17" --bins "-23.0,-16.99,0.5" 
python cmp_main.py -1 band -2 simard -m serexp -b r -x petromag_abs -y rdisk -f -z serexp  --title "PyMorph vs S11 (S11 sample)"  --conditions "  and sfit.galcount = a.galcount and sfit.Prob_n4 <= 0.32 and sfit.Prob_pS <= 0.32 " --add_tables ", r_simard_fit as sfit " -u 100 --xl "-23,-17" --bins "-23.0,-16.99,0.5"   --ylab '1 - (r$_{\mathrm{S11}}$/r$_{\mathrm{pm}}$)$_{\mathrm{disk}}$' 
...
python cmp_main.py -1 band -2 sdss -m best -n petro -b r -x petromag_abs -y mtot  --title "PyMorph vs SDSS, full sample" --xl "-24,-16" --bins "-24.0,-15.99,0.5"
python cmp_main.py -1 band -2 sdss -m best -n cmodel -b r -x petromag -y mtot  --title "PyMorph vs SDSS, full sample" 
python cmp_main.py -1 band -2 sdss -m best -n cmodel -b r -x petromag_abs -y mtot  --title "PyMorph vs SDSS, full sample" --xl "-24,-16" --bins "-24.0,-15.99,0.5"
...
python cmp_main.py -1 mendel -2 sdss -m best -n petro -b r -x petromag_abs -y mtot  --title "Men14 vs SDSS (Men14 sample)" -p "_mendel_only" --xl "-23,-17" --bins "-23.0,-16.99,0.5" 
python cmp_main.py -1 mendel -2 sdss -m best -n cmodel -b r -x petromag_abs -y mtot  --title "Men14 vs SDSS (Men14 sample)" -p "_mendel_only" --xl "-23,-17" --bins "-23.0,-16.99,0.5" --xl "-24,-16" --bins "-24.0,-15.99,0.5" 
...
python cmp_main.py -1 band -2 band -m serexp -n ser -b r -x petromag_abs -y mtot -f -z serexp  --title "PyMorph Serexp-Ser "  --conditions "  and a.n_bulge < 7.95 and ( x.flag&pow(2,4)>0 or x.flag&pow(2,1)>0 or x.flag&pow(2,10)>0 or x.flag&pow(2,14)>0) and a.galcount = y.galcount  and y.band = 'r' and y.ftype = 'u' and y.model = 'ser' and ( y.flag&pow(2,0)>0) " --add_tables ",Flags_optimize as y " --yl "-.1,0.2" --ytM 0.05 --ytm 0.025 --ytl "%0.2f" --xl "-23,-17" --bins "-23.0,-16.99,0.5"

python cmp_main.py -1 band -2 band -m serexp -n ser -b r -x petromag_abs -y hrad -f -z serexp  --title "PyMorph Serexp-Ser "  --conditions "  and a.n_bulge < 7.95 and ( x.flag&pow(2,4)>0 or x.flag&pow(2,1)>0 or x.flag&pow(2,10)>0 or x.flag&pow(2,14)>0) and a.galcount = y.galcount  and y.band = 'r' and y.ftype = 'u' and y.model = 'ser' and ( y.flag&pow(2,0)>0) " --add_tables ",Flags_optimize as y " --yl "-.3,0.3" --ytM 0.1 --ytm 0.025 --ytl "%0.2f"  --xl "-23,-17" --bins "-23.0,-16.99,0.5" --ylab '1 - (r$_{\mathrm{Ser}}$/r$_{\mathrm{Ser-Exp}}$)$_{\mathrm{hl}}$'
