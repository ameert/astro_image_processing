...
def read_list(filename, format_string, delimiter = '', column_names = ''):
    ...
    INPUTS: file_name: name of the file listing data
            ...
            delimiter: string that is used to separate data, defualt is
                       whitespace
            column_names: names of columns as a list of strings,
                          if blank, then names are first
                          non-commented line
