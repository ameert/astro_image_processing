...
for band in 'gri':
    ...
    os.system("""mysql -u pymorph -ppymorph catalog -e "select b.galcount, b.m_tot - c.extinction_{band}, b.hrad_corr,  b.BT, b.m_bulge - c.extinction_{band},  b.n_bulge, IFNULL(b.r_bulge*sqrt(b.ba_bulge),-999),  b.m_disk - c.extinction_{band},  IFNULL(b.r_disk*sqrt(b.ba_disk),-999),d.kcorr_{band} + d.dismod, d.kpc_per_arcsec, -4.5775*m.probaEll -2.35723*m.probaS0+2.48028*m.probaSab+6.0815*m.probaScd, u.flag, c.z, c.petromag_g-c.petromag_r-c.extinction_g+c.extinction_r-d.kcorr_g+d.kcorr_r, petroR90_{band}/petroR50_{band} from M2010 as m, Flags_catalog as u, CAST as c, DERT as d, {band}_band_serexp as b where c.galcount = m.galcount and c.galcount = b.galcount and c.galcount = d.galcount and c.galcount = u.galcount and u.ftype = 'u' and u.band = '{band}' and u.model = 'serexp' and u.flag>=0;" > test.txt """.format(band=band))  
    ...
    np.savez('best_model_data_{band}.npz'.format(band=band), galcount=galcount,mtot=m_tot, 
             r_tot=r_tot, 
