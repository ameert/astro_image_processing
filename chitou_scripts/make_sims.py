...
for model in model_list:
    cmd = "select a.galcount, b.run, b.camcol, b.field,  a.n, a.re, a.re_kpc, a.Ie, a.eb,a.rd, a.Id, a.ed, a.BT, a.zeropoint_sdss_r,a.bpa+90.0, a.dpa+90.0, a.z, b.petroR50_r, a.simcount from  simulations.sim_input as a, CAST as b where  a.galcount = b.galcount and a.simcount between %d and %d order by a.galcount and a.model = '%s';" %(start, stop, model)

    #LOOK HERE!!!!!!!!!!!!!
    # the bpa and dpa ARE given and MUST BE given to the galaxy class in degrees 
    galcount, run, camcol, field, n, re, re_kpc, Ie, eb, rd, Id, ed, BT, zeropoint_sdss_r,bpa, dpa, z, petroR50_r, simcount= cursor.get_data(cmd)
    print galcount
    ...
    for g1, run1, camcol1, field1, n1, re1, re_kpc1, Ie1, eb1, rd1, Id1, ed1, BT1, zeropoint_sdss_r1,bpa1, dpa1, z1, petroR50_r1, half_rad1, simcount1 in zip(galcount, run, camcol, field, n, re, re_kpc, Ie, eb, rd, Id, ed, BT, zeropoint_sdss_r,bpa, dpa, z, petroR50_r, half_rad,simcount):
        ...
        #try:
            ...
            gal = galaxy('/scratch/single_exp/',name,Ie_count,Id_count, rd1, inc, dpa1, re1, eb1, bpa1, n1, bulge_mag = Ie1, disk_mag = Id1, zp = zeropoint_sdss_r1, half_light_arcsec = half_rad1, psf_name= psf_image )
            gal.make_profile()
