...
python cmp_main.py -1 band -2 lackner -m ser -b i -d i -x petromag_abs -y nbulge -f -z ser  --title "PyMorph vs LG12 (LG12 sample)" --conditions "  and lfit.galcount = a.galcount and sfit.galcount = a.galcount and sfit.Prob_Ps > 0.32  " --add_tables ", i_lackner_fit as lfit, r_simard_fit as sfit " -u 100 --yl "-1.0,1.0" --ytM 0.5 --ytm 0.05 --xl "-23,-17" --bins "-23.0,-16.99,0.5"
python cmp_main.py -1 band -2 lackner -m ser -b i -d i -x petrorad -y nbulge -f -z ser  --title "PyMorph vs LG12 (LG12 sample)" --conditions "  and lfit.galcount = a.galcount and sfit.galcount = a.galcount and sfit.Prob_Ps > 0.32  " --add_tables ", i_lackner_fit as lfit, r_simard_fit as sfit " -u 100 --yl "-1,1" --ytM 0.5 --ytm 0.25
