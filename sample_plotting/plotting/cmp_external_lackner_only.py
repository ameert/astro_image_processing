...
data = get_data(cursor, '%s_band_%s' %(band, model), '%s_%s_%s' %(band, tablestem, model), flags = use_flags, flagmodel = flagmodel, add_tables=add_tables, conditions = conditions)
