...
python cmp_main.py -1 band -2 band -m serexp -n serexp -b r -d i -x ttype -y mdisk -f -z serexp  --title "PyMorph r-i"  --yl "-0.5,1.5" --ytM .4 --ytm 0.05  --ylab  '$\Delta$m$_{\mathrm{disk}}$'
python cmp_main.py -1 band -2 band -m serexp -n serexp -b g -d i -x ttype -y mdisk -f -z serexp  --title "PyMorph g-i"  --yl "-0.5,1.5" --ytM .4 --ytm 0.05  --ylab  '$\Delta$m$_{\mathrm{disk}}$'
python cmp_main.py -1 band -2 band -m serexp -n serexp -b g -d r -x ttype -y mdisk -f -z serexp  --title "PyMorph g-r"  --yl "-0.5,1.5" --ytM .4 --ytm 0.05 --ylab  '$\Delta$m$_{\mathrm{disk}}$'

python cmp_main.py -1 band -2 band -m serexp -n serexp -b r -d i -x ttype -y mbulge -f -z serexp  --title "PyMorph r-i"  --yl "-0.5,1.5" --ytM .4 --ytm 0.05    --ylab  '$\Delta$m$_{\mathrm{bulge}}$'
python cmp_main.py -1 band -2 band -m serexp -n serexp -b g -d i -x ttype -y mbulge -f -z serexp  --title "PyMorph g-i"  --yl "-0.5,1.5" --ytM .4 --ytm 0.05    --ylab  '$\Delta$m$_{\mathrm{bulge}}$'
python cmp_main.py -1 band -2 band -m serexp -n serexp -b g -d r -x ttype -y mbulge -f -z serexp  --title "PyMorph g-r"  --yl "-0.5,1.5" --ytM .4 --ytm 0.05  --ylab  '$\Delta$m$_{\mathrm{bulge}}$'
