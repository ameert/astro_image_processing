...
python cmp_main.py -1 simard -2 sdss -m ser -n dev -b r -y sky -x petromag -f -z ser --add_tables ", r_simard_fit as sfit " --conditions " and sfit.galcount = a.galcount and sfit.Prob_Ps > 0.32   "  --title "S11 vs SDSS "
python cmp_main.py -1 simard -2 sdss -m ser -n dev -b r -y sky -x petromag_abs -f -z ser --add_tables ", r_simard_fit as sfit " --conditions " and sfit.galcount = a.galcount and sfit.Prob_Ps > 0.32   " --title "S11 vs SDSS" --xl "-25,-17" --xtM 1 --xtm 0.25 --yl "-1,1" --ytM 1 --ytm 0.25 --ytl "%d"
...
python cmp_main.py -1 simard -2 lackner -m ser -b r -x petromag -y mtot -f -z ser  --title "S11 vs LG12 (LG12 sample)" --conditions "  and lfit.galcount = a.galcount and sfit.galcount = a.galcount and sfit.Prob_Ps > 0.32  " --add_tables ", r_lackner_fit as lfit, r_simard_fit as sfit " -u 100 --yl "-0.2,0.2" --ytM 0.1 --ytm 0.025 
python cmp_main.py -1 simard -2 lackner -m ser -b r -x petromag -y rbulge -f -z ser  --title "S11 vs LG12 (LG12 sample)" --conditions "  and lfit.galcount = a.galcount and sfit.galcount = a.galcount and sfit.Prob_Ps > 0.32  " --add_tables ", r_lackner_fit as lfit, r_simard_fit as sfit " -u 100 --yl "-0.2,0.2" --ytM 0.1 --ytm 0.025 --ylab '1 - (r$_{\mathrm{LG12}}$/r$_{\mathrm{S11}}$)$_{\mathrm{bulge}}$'
python cmp_main.py -1 simard -2 lackner -m ser -b r -x petromag -y nbulge -f -z ser  --title "S11 vs LG12 (LG12 sample)" --conditions "  and lfit.galcount = a.galcount and sfit.galcount = a.galcount and sfit.Prob_Ps > 0.32  " --add_tables ", r_lackner_fit as lfit, r_simard_fit as sfit " -u 100 --yl "-1,1" --ytM 0.5 --ytm 0.25
python cmp_main.py -1 simard -2 lackner -m ser -b r -x petrorad -y nbulge -f -z ser  --title "S11 vs LG12 (LG12 sample)" --conditions "  and lfit.galcount = a.galcount and sfit.galcount = a.galcount and sfit.Prob_Ps > 0.32  " --add_tables ", r_lackner_fit as lfit, r_simard_fit as sfit " -u 100 --yl "-1,1" --ytM 0.5 --ytm 0.25

python cmp_main.py -1 simard -2 lackner -m ser -b r -x petromag_abs -y mtot -f -z ser  --title "S11 vs LG12 (LG12 sample)" --conditions "  and lfit.galcount = a.galcount and sfit.galcount = a.galcount and sfit.Prob_Ps > 0.32  " --add_tables ", r_lackner_fit as lfit, r_simard_fit as sfit " -u 100 --yl "-0.2,0.2" --ytM 0.1 --ytm 0.05 --xl "-23,-17" --bins "-23.0,-16.99,0.5"
python cmp_main.py -1 simard -2 lackner -m ser -b r -x petromag_abs -y rbulge -f -z ser  --title "S11 vs LG12 (LG12 sample)" --conditions "  and lfit.galcount = a.galcount and sfit.galcount = a.galcount and sfit.Prob_Ps > 0.32  " --add_tables ", r_lackner_fit as lfit, r_simard_fit as sfit " -u 100 --yl "-0.2,0.2" --ytM 0.1 --ytm 0.05 --xl "-23,-17" --bins "-23.0,-16.99,0.5" --ylab '1 - (r$_{\mathrm{LG12}}$/r$_{\mathrm{S11}}$)$_{\mathrm{bulge}}$'
python cmp_main.py -1 simard -2 lackner -m ser -b r -x petromag_abs -y nbulge -f -z ser  --title "S11 vs LG12 (LG12 sample)" --conditions "  and lfit.galcount = a.galcount and sfit.galcount = a.galcount and sfit.Prob_Ps > 0.32  " --add_tables ", r_lackner_fit as lfit, r_simard_fit as sfit " -u 100 --yl "-0.2,0.2" --ytM 0.1 --ytm 0.05 --xl "-23,-17" --bins "-23.0,-16.99,0.5"
python cmp_main.py -1 simard -2 lackner -m ser -b r -x petrorad -y nbulge -f -z ser  --title "S11 vs LG12 (LG12 sample)" --conditions "  and lfit.galcount = a.galcount and sfit.galcount = a.galcount and sfit.Prob_Ps > 0.32  " --add_tables ", r_lackner_fit as lfit, r_simard_fit as sfit " -u 100 --yl "-1,1" --ytM 0.5 --ytm 0.25
...
python cmp_main.py -1 simard -2 lackner -m devexp -b r -x petromag -y mtot -f -z devexp --title "S11 vs LG12 (LG12 sample)"  --conditions "  and lfit.galcount = a.galcount and lfit.model = 'nb4' " --add_tables ", r_lackner_fit as lfit " -u 100  --yl "-0.2,0.2" --ytM 0.1 --ytm 0.01
python cmp_main.py -1 simard -2 lackner -m devexp -b r -x petrorad -y hrad -f -z devexp  --title "S11 vs LG12 (LG12 sample)"  --conditions "  and lfit.galcount = a.galcount and lfit.model = 'nb4' " --add_tables ", r_lackner_fit as lfit " -u 100 --yl "-0.3,0.3" --ytM 0.1 --ytm 0.025    --ylab '1 - (r$_{\mathrm{LG12}}$/r$_{\mathrm{pm}}$)$_{\mathrm{disk}}$'
python cmp_main.py -1 simard -2 lackner -m devexp -b r -x petromag -y hrad -f -z devexp  --title "S11 vs LG12 (LG12 sample)"  --conditions "  and lfit.galcount = a.galcount and lfit.model = 'nb4' " --add_tables ", r_lackner_fit as lfit " -u 100 --yl "-0.3,0.3" --ytM 0.1 --ytm 0.025    --ylab '1 - (r$_{\mathrm{LG12}}$/r$_{\mathrm{S11}}$)$_{\mathrm{hl}}$'
python cmp_main.py -1 simard -2 lackner -m devexp -b r -x BT -y BT -f -z devexp  --title "S11 vs LG12 (LG12 sample)"  --conditions "  and lfit.galcount = a.galcount and lfit.model = 'nb4' " --add_tables ", r_lackner_fit as lfit " -u 100
python cmp_main.py -1 simard -2 lackner -m devexp -b r -x petromag -y BT -f -z devexp  --title "S11 vs LG12 (LG12 sample)"  --conditions "  and lfit.galcount = a.galcount and lfit.model = 'nb4' " --add_tables ", r_lackner_fit as lfit " -u 100
python cmp_main.py -1 simard -2 lackner -m devexp -b r -x petromag -y mbulge -f -z devexp  --title "S11 vs LG12 (LG12 sample)"  --conditions "  and lfit.galcount = a.galcount and lfit.model = 'nb4' " --add_tables ", r_lackner_fit as lfit " -u 100
python cmp_main.py -1 simard -2 lackner -m devexp -b r -x petromag -y rbulge -f -z devexp  --title "S11 vs LG12 (LG12 sample)"  --conditions "  and lfit.galcount = a.galcount and lfit.model = 'nb4' " --add_tables ", r_lackner_fit as lfit " -u 100   --ylab '1 - (r$_{\mathrm{LG12}}$/r$_{\mathrm{S11}}$)$_{\mathrm{bulge}}$'
python cmp_main.py -1 simard -2 lackner -m devexp -b r -x petromag -y mdisk -f -z devexp  --title "S11 vs LG12 (LG12 sample)"  --conditions "  and lfit.galcount = a.galcount and lfit.model = 'nb4' " --add_tables ", r_lackner_fit as lfit " -u 100 --yl "-0.2,0.2" --ytM 0.1 --ytm 0.01
python cmp_main.py -1 simard -2 lackner -m devexp -b r -x petromag -y rdisk -f -z devexp  --title "S11 vs LG12 (LG12 sample)"  --conditions "  and lfit.galcount = a.galcount and lfit.model = 'nb4' " --add_tables ", r_lackner_fit as lfit " -u 100 --yl "-0.2,0.2" --ytM 0.1 --ytm 0.01   --ylab '1 - (r$_{\mathrm{LG12}}$/r$_{\mathrm{S11}}$)$_{\mathrm{disk}}$'





python cmp_main.py -1 simard -2 lackner -m devexp -b r -x petromag_abs -y mtot -f -z devexp --title "S11 vs LG12 (LG12 sample)"  --conditions "  and lfit.galcount = a.galcount and lfit.model = 'nb4' " --add_tables ", r_lackner_fit as lfit " -u 100  --yl "-0.2,0.2" --ytM 0.1 --ytm 0.01  --xl "-23,-17" --bins "-22.5,-17.49,0.5"
python cmp_main.py -1 simard -2 lackner -m devexp -b r -x petrorad -y hrad -f -z devexp  --title "S11 vs LG12 (LG12 sample)"  --conditions "  and lfit.galcount = a.galcount and lfit.model = 'nb4' " --add_tables ", r_lackner_fit as lfit " -u 100 --yl "-0.3,0.3" --ytM 0.1 --ytm 0.025  --xl "-23,-17" --bins "-22.5,-17.49,0.5"   --ylab '1 - (r$_{\mathrm{LG12}}$/r$_{\mathrm{S11}}$)$_{\mathrm{hl}}$'
python cmp_main.py -1 simard -2 lackner -m devexp -b r -x petromag_abs -y hrad -f -z devexp  --title "S11 vs LG12 (LG12 sample)"  --conditions "  and lfit.galcount = a.galcount and lfit.model = 'nb4' " --add_tables ", r_lackner_fit as lfit " -u 100 --yl "-0.3,0.3" --ytM 0.1 --ytm 0.025  --xl "-23,-17" --bins "-22.5,-17.49,0.5"  --ylab '1 - (r$_{\mathrm{LG12}}$/r$_{\mathrm{S11}}$)$_{\mathrm{hl}}$'
python cmp_main.py -1 simard -2 lackner -m devexp -b r -x BT -y BT -f -z devexp  --title "S11 vs LG12 (LG12 sample)"  --conditions "  and lfit.galcount = a.galcount and lfit.model = 'nb4' " --add_tables ", r_lackner_fit as lfit " -u 100 
python cmp_main.py -1 simard -2 lackner -m devexp -b r -x petromag_abs -y BT -f -z devexp  --title "S11 vs LG12 (LG12 sample)"  --conditions "  and lfit.galcount = a.galcount and lfit.model = 'nb4' " --add_tables ", r_lackner_fit as lfit " -u 100 --xl "-23,-17" --bins "-22.5,-17.49,0.5"
python cmp_main.py -1 simard -2 lackner -m devexp -b r -x petromag_abs -y mbulge -f -z devexp  --title "S11 vs LG12 (LG12 sample)"  --conditions "  and lfit.galcount = a.galcount and lfit.model = 'nb4' " --add_tables ", r_lackner_fit as lfit " -u 100 --xl "-23,-17" --bins "-22.5,-17.49,0.5"
python cmp_main.py -1 simard -2 lackner -m devexp -b r -x petromag_abs -y rbulge -f -z devexp  --title "S11 vs LG12 (LG12 sample)"  --conditions "  and lfit.galcount = a.galcount and lfit.model = 'nb4' " --add_tables ", r_lackner_fit as lfit " -u 100 --xl "-23,-17" --bins "-22.5,-17.49,0.5"   --ylab '1 - (r$_{\mathrm{LG12}}$/r$_{\mathrm{S11}}$)$_{\mathrm{bulge}}$'
python cmp_main.py -1 simard -2 lackner -m devexp -b r -x petromag_abs -y mdisk -f -z devexp  --title "S11 vs LG12 (LG12 sample)"  --conditions "  and lfit.galcount = a.galcount and lfit.model = 'nb4' " --add_tables ", r_lackner_fit as lfit " -u 100 --yl "-0.2,0.2" --ytM 0.1 --ytm 0.01 --xl "-23,-17" --bins "-22.5,-17.49,0.5"
python cmp_main.py -1 simard -2 lackner -m devexp -b r -x petromag_abs -y rdisk -f -z devexp  --title "S11 vs LG12 (LG12 sample)"  --conditions "  and lfit.galcount = a.galcount and lfit.model = 'nb4' " --add_tables ", r_lackner_fit as lfit " -u 100 --yl "-0.2,0.2" --ytM 0.1 --ytm 0.01 --xl "-23,-17" --bins "-22.5,-17.49,0.5"   --ylab '1 - (r$_{\mathrm{LG12}}$/r$_{\mathrm{S11}}$)$_{\mathrm{disk}}$'
...
python cmp_main.py -1 band -2 sdss -m best -n cmodel -b r -x petromag -y mtot  --title "PyMorph vs SDSS (Joint sample)" --conditions "  and lfit.galcount = a.galcount and x.flag&pow(2,19)=0 " --add_tables ", r_mendel_best as lfit " -p "_joint_only" 
python cmp_main.py -1 band -2 sdss -m best -n cmodel -b r -x petromag_abs -y mtot    --title "PyMorph vs SDSS (Joint sample)" --conditions "  and lfit.galcount = a.galcount  and x.flag&pow(2,19)=0 " --add_tables ", r_mendel_best as lfit " -p "_joint_only" --xl "-24.0,-16" --bins "-24.0,-15.99,0.5" 
python cmp_main.py -1 simard -2 sdss -m best -n cmodel -b r -x petromag -y mtot  --title "S11 vs SDSS (Joint sample)" --conditions "  and lfit.galcount = a.galcount  and x.flag&pow(2,19)=0 " --add_tables ", r_mendel_best as lfit " -p "_joint_only"
python cmp_main.py -1 simard -2 sdss -m best -n cmodel -b r -x petromag_abs -y mtot    --title "S11 vs SDSS (Joint sample)" --conditions "  and lfit.galcount = a.galcount  and x.flag&pow(2,19)=0 " --add_tables ", r_mendel_best as lfit " -p "_joint_only" --xl "-24.0,-16" --bins "-24.0,-15.99,0.5" 
python cmp_main.py -1 mendel -2 sdss -m best -n cmodel -b r -x petromag_abs -y mtot  --title "Men14 vs SDSS (Joint sample)" -p "_joint_only" --xl "-24.0,-17" --bins "-24.0,-16.99,0.5"  --conditions "  and  x.flag&pow(2,19)=0 "
python cmp_main.py -1 mendel -2 sdss -m best -n cmodel -b r -x petromag -y mtot  --title "Men14 vs SDSS (Joint sample)" -p "_joint_only" --conditions "  and x.flag&pow(2,19)=0 "


python cmp_main.py -1 band -2 sdss -m best -n petro -b r -x petromag -y mtot  --title "PyMorph vs SDSS (Joint sample)" --conditions "  and lfit.galcount = a.galcount and x.flag&pow(2,19)=0 " --add_tables ", r_mendel_best as lfit " -p "_joint_only" 
python cmp_main.py -1 band -2 sdss -m best -n petro -b r -x petromag_abs -y mtot    --title "PyMorph vs SDSS (Joint sample)" --conditions "  and lfit.galcount = a.galcount  and x.flag&pow(2,19)=0 " --add_tables ", r_mendel_best as lfit " -p "_joint_only" --xl "-24.0,-16" --bins "-24.0,-15.99,0.5" 
python cmp_main.py -1 simard -2 sdss -m best -n petro -b r -x petromag -y mtot  --title "S11 vs SDSS (Joint sample)" --conditions "  and lfit.galcount = a.galcount  and x.flag&pow(2,19)=0 " --add_tables ", r_mendel_best as lfit " -p "_joint_only"
python cmp_main.py -1 simard -2 sdss -m best -n petro -b r -x petromag_abs -y mtot    --title "S11 vs SDSS (Joint sample)" --conditions "  and lfit.galcount = a.galcount  and x.flag&pow(2,19)=0 " --add_tables ", r_mendel_best as lfit " -p "_joint_only" --xl "-24.0,-16" --bins "-24.0,-15.99,0.5" 
python cmp_main.py -1 mendel -2 sdss -m best -n petro -b r -x petromag -y mtot  --title "Men14 vs SDSS (Joint sample)" -p "_joint_only"  --conditions "  and x.flag&pow(2,19)=0 "
python cmp_main.py -1 mendel -2 sdss -m best -n petro -b r -x petromag_abs -y mtot  --title "Men14 vs SDSS (Joint sample)" -p "_joint_only" --xl "-24.0,-17" --bins "-24.0,-16.99,0.5"  --conditions "  and x.flag&pow(2,19)=0 "
...
mv r_simard_sdss_petro_*.eps r_simard_sdss_petro_*.tbl /home/ameert/git_projects/catalog2013/figures/cmp_plots/petro/
mv r_mendel_sdss_petro_*.eps r_mendel_sdss_petro_*.tbl /home/ameert/git_projects/catalog2013/figures/cmp_plots/petro/
...
python cmp_main.py -1 band -2 band -m serexp -n ser -b r -x petromag_abs -y mtot -f -z serexp  --title "PyMorph Serexp-Ser "  --conditions "  and a.n_bulge < 7.95 and ( x.flag&pow(2,4)>0 or x.flag&pow(2,1)>0 or x.flag&pow(2,10)>0 or x.flag&pow(2,14)>0) and a.galcount = y.galcount  and y.band = 'r' and y.ftype = 'u' and y.model = 'ser' and ( y.flag&pow(2,0)>0) " --add_tables ",Flags_optimize as y " --yl "-.1,0.199999" --ytM 0.05 --ytm 0.025 --ytl "%0.2f" --xl "-24.0,-17" --bins "-24.0,-16.99,0.5"
