...
def pub_plots(xmaj = 5, xmin = 1, xstr = '%03.2f', ymaj = 5, ymin = 1, ystr = '%d'):
    MatPlotParams = {'axes.titlesize': 12, 'axes.linewidth' : 2.5, 'axes.labelsize': 16, 'xtick.labelsize': 12, 'ytick.labelsize': 12, 'xtick.major.size': 10, 'ytick.major.size' : 10, 'xtick.minor.size': 6, 'ytick.minor.size': 6, 'xtick.major.pad' : 8, 'ytick.major.pad' : 6}
