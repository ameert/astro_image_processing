...
'''
    ...
    interior_pts = n.array([]) #alan added this
    prev_pts = len(pts) + 1
    k = 0
    while prev_pts > n_pts:
        ...
        while i < (n_pts - 2):
            ...
            if Aij + Ajk < Aik:
                ...
                interior_pts = n.append(interior_pts, [pts[i+1]])#alan added this
                del pts[i+1]
            i += 1
            n_pts = len(pts)
        k += 1
    return n.asarray(pts), n.asarray(interior_pts)#alan added this
