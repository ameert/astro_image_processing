...
file_path = '/data2/home/ameert/hst_sims/fits/%s/%04d' %(model, folder_num)
mask_path = '/data2/home/ameert/hst_sims/fits/%s/%04d' %(model, folder_num)
os.chdir(file_path)

cmd = 'select galcount, re_pix, eb, n, rd_pix, ed from %s order by galcount;' %(tablename) 
print cmd
