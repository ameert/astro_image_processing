...
os.system('/data2/home/ameert/color_grads/scripts/regen_galaxy.py %d ser %d %s ./' %(galcount, folder_num, band))
...
outfile = '/data2/home/ameert/color_grads/data/%04d/%08d_%s.resid' %(folder_num,galcount,'r_ser')
out = open(outfile, 'w')
