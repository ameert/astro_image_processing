...
insert into g_band_best select a.* from g_band_serexp as a, catalog.Flags_catalog as b where a.galcount = b.galcount and b.model='serexp' and b.band='g' and b.ftype='u' and (b.flag&pow(2,10)>0 or b.flag&pow(2,14)>0 or b.flag&pow(2,19)>0);
