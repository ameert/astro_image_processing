...
cmdfilecmd = """LOAD DATA INFILE '{infile}' IGNORE INTO TABLE {tablename}  FIELDS TERMINATED BY ',' IGNORE 1 LINES;""".format(infile=infile, tablename=tablename)
print cmdfilecmd
